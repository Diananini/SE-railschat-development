class ChatsController < ApplicationController
  ...
  def index
    require 'set'
    i_inverse_friends = Set.new(current_user.friends)
    inverse_i_friends = Set.new(current_user.inverse_friends)

    @friends= i_inverse_friends & inverse_i_friends
    @inverse_i_friends = inverse_i_friends - @friends
    @i_inverse_friends = i_inverse_friends - @friends
  end
